    ...
    public function up()
    {
        ...
        $data = [
            ...
            [
                ...
                'created_at'  => $now,
                'updated_at'  => $now,   
                'permissions' => json_encode(['manage_post', 'manage_social_profile','manage_subscription', 'manage_team', 'manage_campaigns', 'manage_ticket', 'manage_setting','manage_api']),
            ],
        ];
        Role::insert($data); 
    }
