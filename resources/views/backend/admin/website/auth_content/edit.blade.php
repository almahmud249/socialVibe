		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xxl-9 col-lg-8 col-md-8">
					<h3 class="section-title">{{ __('edit_content') }}</h3>
					<div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
						<div class="row">
							<form action="{{ route('content.update', $content->id) }}" method="POST" class="form" enctype="multipart/form-data">
								@csrf
								@method('PUT')
								<div class="row gx-20 add-coupon">
									...
									<input type="hidden"
									       value="{{ @$content_language->translation_null == 'not-found' ? '' : @$content_language->id }}"
									       name="translate_id">
									...
									<div class="col-lg-12">
										<div class="mb-4">
											...
											<input type="text" class="form-control rounded-2 ai_content_name" id="title"
											       name="title" value="{{ @$content_language->title }}">
									...
									<div class="col-lg-12 input_file_div mb-4">
										<div class="mb-3">
											<label class="form-label mb-1">{{__('image') }}(400X387)</label>
										...
										<div class="selected-files d-flex flex-wrap gap-20">
											<div class="selected-files-item">
												<img class="selected-img" src="{{ getFileLink('original_image', $content->image) }}"
													 alt="favicon">
											</div>
										</div>
									</div>
									<div class="d-flex gap-12 sandbox_mode_div mb-4">
										...
										<div class="setting-check">
											<input type="checkbox" value="1" id="status"
											       class="sandbox_mode" {{ @$content->status == 1 ? 'checked' : '' }}>
