					...
					<div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
						<form action="{{ route('admin.section_title_subtitle') }}" method="POST" class="form">
							...
							<div class="row gx-20 add-coupon">
								...
								<div class="col-lg-12">
									<div class="mb-4">
										<label for="blog_section_title"
										       class="form-label">{{ __('blog_section_title') }}</label>
										<input type="text" class="form-control rounded-2 ai_content_name"
										       id="blog_section_title" name="blog_section_title"
										       value="{{ setting('blog_section_title', $lang) }}">
										<div class="nk-block-des text-danger">
											<p class="blog_section_title_error error"></p>
										</div>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="mb-4">
										<label for="blog_section_subtitle"
										       class="form-label">{{ __('blog_section_subtitle') }}</label>
										<input type="text" class="form-control rounded-2 ai_content_name"
										       id="blog_section_subtitle" name="blog_section_subtitle"
										       value="{{ setting('blog_section_subtitle', $lang) }}">
										<div class="nk-block-des text-danger">
											<p class="faq_section_subtitle_error error"></p>
										</div>
									</div>
