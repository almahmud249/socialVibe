			...
			<ul class="default-sidenav">
				...
				<li>
					<a href="{{ route('admin.menu') }}"
					   class="{{ request()->routeIs('admin.menu') || request()->routeIs('admin.menu') || request()->routeIs('website.menu') ? 'active' : '' }}">
				...
				@endcan
					<li>
						<a href="{{ route('customers.index') }}"
						   class="{{ request()->routeIs(['customers.index', 'customers.create', 'customers.edit']) ? 'active' : '' }}">
							<span class="icon"><i class="las la-handshake"></i></span>
							<span>{{ __('client_section') }}</span>
						</a>
					</li>
				<li>
					<a href="{{ route('admin.growth.section') }}"
					   class="{{ request()->routeIs(['admin.growth.section','growths.edit']) ? 'active' : '' }}">
						<span class="icon"><i class="las la-user-friends"></i></span>
						<span>{{ __('growth') }}</span>
					</a>
				</li>
					<li>
						<a href="{{ route('integrate.index') }}"
						   class="{{ request()->routeIs(['integrate.index','integrate.edit']) ? 'active' : '' }}">
							<span class="icon"><i class="las la-plus-circle"></i></span>
							<span>{{ __('integrate_section') }}</span>
						</a>
					</li>
				...
				@can('footer.content')
					<li>
						<a href="{{ route('content.index') }}"
						   class="@if(request()->routeIs('content.index') || request()->routeIs('content.create') || request()->routeIs('content.edit')) active @endif">
							<span class="icon"><i class="las la-sign-in-alt"></i></span>
							<span>{{ __('auth_content') }}</span>
						</a>
					</li>
				@endcan
