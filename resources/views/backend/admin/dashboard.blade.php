                ...
                <div class="col-xl-8 col-md-12">
                    <div class="bg-white redious-border mb-4 pt-20 p-30">
                        ...
                        <div class="statistics-report">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="analytics clr-6 mb-40">
                        ...
                        <div class="col-xxl-6 col-md-6">
                            <div class="statistics-card bg-white color-success redious-border mb-4 p-20 p-sm-20">
                                ...
                                <div class="statistics-info mt-1">
                                    <h6>{{ __('total_profile') }}</h6>
                                    <h4>{{ ReadableNumbers::make($total_profile, 2) }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-6 col-md-6">
                            <div class="statistics-card bg-white color-danger redious-border mb-4 p-20 p-sm-20">
                                <div class="statistics-icon">
                                    <svg width="28" height="28" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
                                ...
                                <div class="statistics-info mt-1">
                                    <h6>{{ __('total_post') }}</h6>
                                    <h4>{{ ReadableNumbers::make($total_post, 2) }}</h4>
                                </div>
                            </div>
                        </div>
