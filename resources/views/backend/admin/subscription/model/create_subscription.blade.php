<div class="modal fade" id="subscription" tabindex="-1" aria-labelledby="subscription" aria-hidden="false">
						...
						<div class="col-lg-12">
							<div class="mb-4">
								...
								<select class="form-select rounded-0 mb-3 without_search"
									...
									<option value="{{ $plan->id }}" data-price="{{ $plan->price }}">{{ $plan->name }} - {{ __($plan->billing_period) }}</option>
									@endforeach
								</select>
								<div class="nk-block-des text-danger">
