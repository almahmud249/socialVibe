                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-item">
                                                <input id="country_selector" name="billing_country" class="form-control"
                                                    type="text" value="">
                                                <label for="country_selector" style="display:none;">{{__('Select_a_country_here')}}</label>
                                            </div>
                                            <div class="form-item" style="display:none;">
                                                ...
                                                <label for="country_selector_code">{{__('and_the_selected_country_code_will_be_updated_here')}}</label>
                                            </div>
