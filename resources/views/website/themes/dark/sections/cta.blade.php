...
@if(setting('cta_enable')== 1)
	<section class="call__to__action p-0" id="cta">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="ctaBox__wrapper wow fadeInUp" data-wow-delay=".2s">
						<div class="ctaBox__inner wow fadeInUp" data-wow-delay=".3s">
							<div class="ctaBox__icon">
								<img src="{{ static_asset('website/themes/dark/assets/images/union-icon.png') }}"
								     alt="union-icon"/>
							</div>
						...
						<a href="{{ setting('cta_main_action_btn_url') }}"
						   class="btn btn-primary">{!! setting('cta_main_action_btn_label', app()->getLocale()) !!}<i
