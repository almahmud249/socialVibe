		...
		<section class="testimonial__section" id="testimonials">
			<div class="container">
				<div class="row">
					<div class="col-12">
								...
								<div class="swiper-slide">
									<div class="testimonial__item">
										<div class="testimonial__avatar">
											<div class="avatar">
												<img src="{{ getFileLink('original_image',  $testimonial->image) }}" alt="{{ @$testimonial->language->name, app()->getLocale() }}" />
											</div>
											...
											<div class="company__logo">
												<img src="{{ getFileLink('original_image',  $testimonial->logo,null,'120x40') }}" alt="{{ @$testimonial->language->name, app()->getLocale() }}" />
											</div>
										</div>
