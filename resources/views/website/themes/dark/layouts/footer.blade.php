							...
							<div class="footer__widget">
								...
								<div class="footer__toplink">
									<div class="footer__link d-flex align-items-center">
										<div class="icon">
											<img src="{{ static_asset('website/themes/default/assets/images/email.svg')}}" alt="email" />
										</div>
										<a href="mailto:{!! setting('contact_email', app()->getLocale()) !!}">{!! setting('contact_email', app()->getLocale()) !!}</a>
									</div>
									<div class="footer__link d-flex align-items-center">
										<div class="icon">
											<img src="{{ static_asset('website/themes/default/assets/images/phone.svg')}}" alt="phone" />
										</div>
						...
						<div class="col-12">
							<div class="footer__content wow fadeInUp" data-wow-delay=".3s">
								...
								<div class="footer__apps">
									<a href="javascript:void(0)"><img src="{{ setting('payment_method_banner') && @is_file_exists(setting('payment_method_banner')['original_image']) ? get_media(setting('payment_method_banner')['original_image']) : get_media('frontend/img/payment-methods/footer-payment.png') }}" alt="payment" /></a>
								</div>
								@endif
							</div>
						</div>
