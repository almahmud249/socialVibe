...
<html lang="{{ systemLanguage() ? systemLanguage()->locale : 'en' }}"
    ...
    <head>
		...
		<!-- font awesome -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/all.min.css')}}" />
		<!-- FancyBox -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/jquery.fancybox.min.css')}}" />
		<!-- Animate Animation -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/animate.css')}}" />

	    <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/aos.css')}}"/>

	    <!-- Remix Icon -->
	    <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/remixicon.css')}}"/>
	    <!-- bootstraph -->
	    <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/bootstrap.min.css')}}" />
	    <!-- FancyBox -->
	    <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/jquery.fancybox.min.css')}}" />
	    <!-- Swiper Slider -->
	    <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/swiper-bundle.min.css')}}" />
        <!-- User's CSS Here -->
        <link rel="stylesheet" href="{{ static_asset('website/themes/default/assets/css/style.css')}}" />
	    <!-- Aos Animation -->
        @stack('css')

	</head>
	<body>
            @include('website.themes.default.layouts.header')
		@yield('content')
            @include('website.themes.default.layouts.footer')
		<!-- JS -->
            <script src="{{ static_asset('website/themes/default/assets/js/jquery-3.7.1.min.js')}}"></script>
            <!-- bootstrap js -->
            <script src="{{ static_asset('website/themes/default/assets/js/bootstrap.min.js')}}"></script>
            <!-- fancybox -->
            <script src="{{ static_asset('website/themes/default/assets/js/jquery.fancybox.min.js')}}"></script>
            <!-- swiper slider -->
            <script src="{{ static_asset('website/themes/default/assets/js/swiper-bundle.min.js')}}"></script>
            <!-- aos animation -->
            <script src="{{ static_asset('website/themes/default/assets/js/aos.js')}}"></script>
            <!-- Smooth Scroll -->
            <script src="{{ static_asset('website/themes/default/assets/js/smooth-scroll.js')}}"></script>
            <!-- main js -->
            <script src="{{ static_asset('website/themes/default/assets/js/scripts.js')}}"></script>
