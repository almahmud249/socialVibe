...
class WebsiteIntegrate extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(WebsiteIntegrateLanguage::class);
    }

    public function language(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
        return $this->hasOne(WebsiteIntegrateLanguage::class, 'website_integrates_id', 'id')->where('lang', app()->getLocale());
    }
