    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($blog_category) {
                return view('backend.admin.blog_category.action', compact('blog_category'));
            })->addColumn('status', function ($blog_category) {
                return view('backend.admin.blog_category.status', compact('blog_category'));
            })->addColumn('title', function ($blog_category) {
                return $blog_category->lang_title;
            })->setRowId('id');
    }
